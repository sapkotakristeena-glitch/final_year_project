    ...
    const fetchDashboardData = async () => {
      try {
        ...
        const [statsRes, complaintsRes] = await Promise.all([
          ...
          fetch("http://localhost:5000/api/complaints/recent", { headers }),
        ]);
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "20px", marginBottom: "28px" }}>
            ...
            <div style={{
              ...
              <p style={{ fontSize: "13px", color: "#718096", margin: "0 0 16px" }}>
                View, assign, and update complaint statuses
              </p>
              <button
              ...
              <tbody>
                {recentComplaints.length > 0 ? (
                  recentComplaints.map((comp, i) => (
                    ...
                    >
                      <td style={{ padding: "14px 20px", fontSize: "14px", fontWeight: "700", color: "#1a2b45", borderBottom: "1px solid #F0F6FC" }}>{comp.id}</td>
                      <td style={{ padding: "14px 20px", fontSize: "14px", color: "#2d3748", borderBottom: "1px solid #F0F6FC" }}>{comp.title}</td>
                      <td style={{ padding: "14px 20px", fontSize: "14px", color: "#4A5568", borderBottom: "1px solid #F0F6FC" }}>{comp.category}</td>
                      <td style={{ padding: "14px 20px", fontSize: "14px", color: "#4A5568", borderBottom: "1px solid #F0F6FC" }}>{comp.date}</td>
                      <td style={{ padding: "14px 20px", borderBottom: "1px solid #F0F6FC" }}>
                        <span style={{
                          ...(STATUS_STYLES[comp.status] || STATUS_STYLES.Pending),
